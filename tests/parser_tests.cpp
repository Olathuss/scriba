...
void test_atomic_success() {
    ...
    expect_ast("atomic: identifier with literal arg",
        "on test():\n    x(5)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Literal 5)))\n"
        ")\n"
    );
    ...
    expect_ast("atomic: grouping identifier",
        "on test():\n    x((y))\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Group (Ident y))))\n"
        ")\n"
    );
    ...
    expect_ast("atomic: member access",
        "on test():\n    x(y.z)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Member (Ident y) z)))\n"
        ")\n"
    );
    ...
    expect_ast("atomic: member access",
        "on test():\n    x.y(z)\n",
        "(Event test:\n"
        "\t(Command (Call (Member (Ident x) y) (Ident z)))\n"
        ")\n"
    );
    ...
    expect_ast("atomic: array number argument",
        "on test():\n    x([1, 2, 3])\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Array (Literal 1) (Literal 2) (Literal 3))))\n"
        ")\n"
    );
    ...
    expect_ast("atomic: array string argument",
        "on test():\n    x([\"hello\", \"world\"])\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Array (Literal \"hello\") (Literal \"world\"))))\n"
        ")\n"
    );
    ...
    expect_ast("atomic: array identifier argument",
        "on test():\n    x([hello, world])\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Array (Ident hello) (Ident world))))\n"
        ")\n"
    );
    ...
    expect_ast("atomic: nested array argument",
        "on test():\n    x([1, [2, 3], 4])\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Array (Literal 1) (Array (Literal 2) (Literal 3)) (Literal 4))))\n"
        ")\n"
    );
    ...
    expect_ast("atomic: array grouping argument",
        "on test():\n    x([(1), (2)])\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Array (Group (Literal 1)) (Group (Literal 2)))))\n"
        ")\n"
    );
    ...
    expect_ast("atomic: array member access argument",
        "on test():\n    x([a.b, c.d])\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Array (Member (Ident a) b) (Member (Ident c) d))))\n"
        ")\n"
    );
    ...
    expect_ast("atomic: array range argument",
        "on test():\n    x([1..5])\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Array (Range (Literal 1) (Literal 5)))))\n"
        ")\n"
    );
...
void test_atomic_failure() {
    ...
    expect_parse_error("atomic: invalid event",
        "on test:\n    x()\n"
    );

    expect_parse_error("atomic: invalid call",
        "on test():\n    x\n"
    );

    expect_parse_error("atomic: missing closing )",
        "on test():\n    x(y\n"
    );

    expect_parse_error("atomic: missing comma on event parameters",
        "on test(x y):\n    x(y)\n"
    );

    expect_parse_error("atomic: missing comma on call arguments",
        "on test(x y):\n    x(y z)\n"
    );
...
void test_unary_success() {
    expect_ast("unary: negative literal",
        "on test():\n    x(-1)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Unary - (Literal 1))))\n"
        ")\n"
    );
    ...
    expect_ast("unary: negative identifier",
        "on test():\n    x(-y)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Unary - (Ident y))))\n"
        ")\n"
    );
    ...
    expect_ast("unary: not identifier",
        "on test():\n    x(!flag)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Unary ! (Ident flag))))\n"
        ")\n"
    );
    ...
    expect_ast("unary: grouping",
        "on test():\n    x(-(1))\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Unary - (Group (Literal 1)))))\n"
        ")\n"
    );
    ...
    expect_ast("unary: member access",
        "on test():\n    x(-a.b)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Unary - (Member (Ident a) b))))\n"
        ")\n"
    );
    ...
    expect_ast("unary: member access",
        "on test():\n    x(!a.b.c)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Unary ! (Member (Member (Ident a) b) c))))\n"
        ")\n"
    );
    ...
    expect_ast("unary: array literal",
        "on test():\n    x(-[1,2])\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Unary - (Array (Literal 1) (Literal 2)))))\n"
        ")\n"
    );
    ...
    expect_ast("unary: range",
        "on test():\n    x(-(1..5))\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Unary - (Group (Range (Literal 1) (Literal 5))))))\n"
        ")\n"
    );
    ...
    expect_ast("unary: chain",
        "on test():\n    x(!!-y)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Unary ! (Unary ! (Unary - (Ident y))))))\n"
        ")\n"
    );
    ...
    expect_ast("unary: grouping tightness",
        "on test():\n    x(!((1)))\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Unary ! (Group (Group (Literal 1))))))\n"
        ")\n"
    );
}
...
void test_binary_success() {
    expect_ast("binary: addition",
        "on test():\n    x(1 + 2)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary + (Literal 1) (Literal 2))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: subtraction",
        "on test():\n    x(54 - 25)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary - (Literal 54) (Literal 25))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: multiplication",
        "on test():\n    x(123 * 256)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary * (Literal 123) (Literal 256))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: division",
        "on test():\n    x(8 / 2)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary / (Literal 8) (Literal 2))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: precedence * over +",
        "on test():\n    x(1 + 2 * 3)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary + (Literal 1) (Binary * (Literal 2) (Literal 3)))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: precedence / over -",
        "on test():\n    x(10 - 6 / 2)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary - (Literal 10) (Binary / (Literal 6) (Literal 2)))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: associativity left",
        "on test():\n    x(1 - 2 - 3)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary - (Binary - (Literal 1) (Literal 2)) (Literal 3))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: grouping overrides precedence",
        "on test():\n    x((1 + 2) * 3)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary * (Group (Binary + (Literal 1) (Literal 2))) (Literal 3))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: comparison less or equal",
        "on test():\n    x(3 <= 2)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary <= (Literal 3) (Literal 2))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: comparison greater or equal",
        "on test():\n    x(4 >= 2)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary >= (Literal 4) (Literal 2))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: equality equal",
        "on test():\n    x(a == b)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary == (Ident a) (Ident b))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: and",
        "on test():\n    x(a and b)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (And (Ident a) (Ident b))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: or",
        "on test():\n    x(a or b)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Or (Ident a) (Ident b))))\n"
        ")\n"
    );

    expect_ast("binary: equality not equal",
        "on test():\n    x(a != b)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary != (Ident a) (Ident b))))\n"
        ")\n"
    ...
    expect_ast("binary: precedence comparison over equality",
        "on test():\n    x(1 < 2 == true)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary == (Binary < (Literal 1) (Literal 2)) (Literal true))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: unary inside binary",
        "on test():\n    x(-1 + 2)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary + (Unary - (Literal 1)) (Literal 2))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: member access inside binary",
        "on test():\n    x(a.b + c.d)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary + (Member (Ident a) b) (Member (Ident c) d))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: array inside binary",
        "on test():\n    x([1,2] + [3,4])\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary + (Array (Literal 1) (Literal 2)) (Array (Literal 3) (Literal 4)))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: arithmetic inside range",
        "on test():\n    x(1+1..2+2)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Range (Binary + (Literal 1) (Literal 1)) (Binary + (Literal 2) (Literal 2)))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: grouping and range",
        "on test():\n    x((a+b)..(c+d))\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Range (Group (Binary + (Ident a) (Ident b))) (Group (Binary + (Ident c) (Ident d))))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: complex mixed",
        "on test():\n    x(a.b * (1 + 2) == c.d / 3)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary == (Binary * (Member (Ident a) b) (Group (Binary + (Literal 1) (Literal 2)))) (Binary / (Member (Ident c) d) (Literal 3)))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: precedence and over or",
        "on test():\n    x(a or b and c)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Or (Ident a) (And (Ident b) (Ident c)))))\n"
        ")\n"
    );
    ...
    expect_ast("binary: equality inside logical and",
        "on test():\n    x(a == b and c == d)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (And (Binary == (Ident a) (Ident b)) (Binary == (Ident c) (Ident d)))))\n"
        ")\n"
    );
...
void full_expression_success() {
    ...
    expect_ast("expr: unary + grouping + arithmetic",
        "on test():\n    x(-(1 + 2) * 3)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary * (Unary - (Group (Binary + (Literal 1) (Literal 2)))) (Literal 3))))\n"
        ")\n"
    );
    ...
    expect_ast("expr: unary + member + arithmetic",
        "on test():\n    x(-a.b + 5)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Binary + (Unary - (Member (Ident a) b)) (Literal 5))))\n"
        ")\n"
    );
    ...
    expect_ast("expr: logical and/or with arithmetic",
        "on test():\n    x(a + 1 and b * 2 or c)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Or (And (Binary + (Ident a) (Literal 1)) (Binary * (Ident b) (Literal 2))) (Ident c))))\n"
        ")\n"
    );
    ...
    expect_ast("expr: range with logical operators",
        "on test():\n    x(a and b..c or d)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Or (And (Ident a) (Range (Ident b) (Ident c))) (Ident d))))\n"
        ")\n"
    );
    ...
    expect_ast("expr: deep mixed expression",
        ...
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Or (And (Binary == "
...
void command_success() {
    ...
    expect_ast("cmd: multiple arguments",
        "on test():\n    x(a, b, c)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Ident a) (Ident b) (Ident c)))\n"
        ")\n"
    );
...
void event_block_success() {
    ...
    expect_ast("event block: single command",
        "on test():\n    x(1)\n",
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Literal 1)))\n"
        ")\n"
    );
    ...
    expect_ast("event block: multiple command",
        ...
        "(Event test:\n"
        "\t(Command (Call (Ident x) (Literal 1)))\n"
        "\t(Command (Call (Ident y) (Literal 2)))\n"
        "\t(Command (Call (Ident z) (Binary + (Ident a) (Ident b))))\n"
        ")\n"
    );
    ...
    expect_ast("event block: event with arguments",
        ...
        "\t(Command (Call (Ident damage) (Ident target) (Literal 5)))\n"
        ")\n"
    );
    ...
    expect_ast("event block: mixed expressions inside commands",
        "on update():\n    move(player, (x+1))\n    spawn(goblin, 1..3)\n",
        "(Event update:\n"
        "\t(Command (Call (Ident move) (Ident player) (Group (Binary + (Ident x) (Literal 1)))))\n"
        "\t(Command (Call (Ident spawn) (Ident goblin) (Range (Literal 1) (Literal 3))))\n"
        ")\n"
    );
...
void full_script_success() {
    ...
    expect_ast("full script: if with no else",
        ...
        "\t\t(Then\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"hi\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t\t(Else (NoElse))\n"
        "\t)\n"
    ...
    expect_ast(
        ...
        "\t\t(Then\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"It is a match!\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t\t(Else\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"It is not a match...\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t)\n"
        ")\n"
    ...
    expect_ast("full script: if with else if",
        ...
        "\t\t(Then\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"one\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t\t(Else\n"
        "\t\t\t(If\n"
        ...
        "\t\t\t\t(Then\n"
        "\t\t\t\t\t(Block\n"
        "\t\t\t\t\t\t(Command (Call (Ident say) (Literal \"two\")))\n"
        "\t\t\t\t\t)\n"
        "\t\t\t\t)\n"
        "\t\t\t\t(Else\n"
        "\t\t\t\t\t(Block\n"
        "\t\t\t\t\t\t(Command (Call (Ident say) (Literal \"other\")))\n"
        "\t\t\t\t\t)\n"
        "\t\t\t\t)\n"
        "\t\t\t)\n"
        "\t\t)\n"
    ...
    expect_ast(
        ...
        "\t\t\t\t\t(Then\n"
        "\t\t\t\t\t\t(Block\n"
        "\t\t\t\t\t\t\t(Command (Call (Ident say) (Literal \"nested\")))\n"
        "\t\t\t\t\t\t)\n"
        "\t\t\t\t\t)\n"
        "\t\t\t\t\t(Else (NoElse))\n"
        "\t\t\t\t)\n"
    ...
    expect_ast(
        ...
        "\t\t(Then\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"outer\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t\t(Else\n"
        "\t\t\t(Block\n"
        ...
        "\t\t\t\t\t(Then\n"
        "\t\t\t\t\t\t(Block\n"
        "\t\t\t\t\t\t\t(Command (Call (Ident say) (Literal \"inner\")))\n"
        "\t\t\t\t\t\t)\n"
        "\t\t\t\t\t)\n"
        "\t\t\t\t\t(Else (NoElse))\n"
        "\t\t\t\t)\n"
    ...
    expect_ast(
        ...
        "\t\t(Else\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"bye\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t)\n"
        ")\n"
    ...
    expect_ast(
        ...
        "\t\t(Then\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"both are true\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t\t(Else (NoElse))\n"
        "\t)\n"
    ...
    expect_ast(
        ...
        "\t\t(Then\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"complex\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t\t(Else (NoElse))\n"
        "\t)\n"
    ...
    expect_ast(
        "full script: member access in condition",
        "on test(x, y, z):\n"
        "    if player.health < 10:\n"
        "        say(\"low health\")\n",
        "(Event test x y z:\n"
        ...
        "\t\t(Then\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"low health\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t\t(Else (NoElse))\n"
        "\t)\n"
...
void full_script_success_2() {
    ...
    expect_ast(
        ...
        "\t\t(Then\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident a) (Literal 1)))\n"
        "\t\t\t\t(Command (Call (Ident b) (Literal 2)))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t\t(Else (NoElse))\n"
        "\t)\n"
    ...
    expect_ast(
        ...
        "\t\t(Then\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"yes\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t\t(Else\n"
        "\t\t\t(Block\n"
    ...
    expect_ast(
        ...
        "\t\t\t\t\t\t\t\t(Then\n"
        "\t\t\t\t\t\t\t\t\t(Block\n"
        "\t\t\t\t\t\t\t\t\t\t(Command (Call (Ident say) (Literal \"deep\")))\n"
        "\t\t\t\t\t\t\t\t\t)\n"
        "\t\t\t\t\t\t\t\t)\n"
        "\t\t\t\t\t\t\t\t(Else (NoElse))\n"
        "\t\t\t\t\t\t\t)\n"
...
void trigger_success() {
    std::cout << "Running trigger (success) tests..." << std::endl;

    expect_ast("trigger: no arguments",
        "on test():\n    trigger foo()\n",
        "(Event test:\n"
        "\t(Trigger (Ident foo))\n"
        ")\n"
    ...
    expect_ast("trigger: one argument",
        "on test():\n    trigger foo(1)\n",
        "(Event test:\n"
        "\t(Trigger (Ident foo) (Literal 1))\n"
        ")\n"
    );

    expect_ast("trigger: multiple arguments",
        "on test():\n    trigger foo(a, b, c)\n",
        "(Event test:\n"
        "\t(Trigger (Ident foo) (Ident a) (Ident b) (Ident c))\n"
        ")\n"
    );

    expect_ast("trigger: expression arguments",
        "on test():\n    trigger foo((1+2), a.b, 3..4)\n",
        "(Event test:\n"
        "\t(Trigger (Ident foo) "
        "(Group (Binary + (Literal 1) (Literal 2))) "
        "(Member (Ident a) b) "
    ...
    expect_ast("trigger: unary and binary expressions",
        "on test():\n    trigger foo(-a, b+1)\n",
        "(Event test:\n"
        "\t(Trigger (Ident foo) "
        "(Unary - (Ident a)) "
    ...
    expect_ast("trigger: nested inside if",
        "on test():\n"
        "    if x:\n"
        "        trigger foo(1)\n",
        "(Event test:\n"
    ...
    std::cout << "Trigger (success) tests completed." << std::endl;
}

void trigger_success_2() {
    std::cout << "Running trigger (success) 2 tests..." << std::endl;

    expect_ast("trigger: trigger assignment",
        "on test():\n    success = trigger foo()\n",
        "(Event test:\n"
        "\t(Assignment (Ident success) (Trigger (Ident foo)))\n"
        ")\n"
    );

    expect_ast("trigger: trigger within condition",
        "on test():\n"
        "    if trigger target_hit():\n"
        "        say(\"target hit\")\n",
        "(Event test:\n"
        "\t(If\n"
        "\t\t(Condition (Trigger (Ident target_hit)))\n"
        "\t\t(Then\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"target hit\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t\t(Else (NoElse))\n"
        "\t)\n"
    ...
    std::cout << "Trigger (success) 2 tests completed." << std::endl;
}

void trigger_failure() {
    std::cout << "Running trigger (failure) tests..." << std::endl;

    expect_parse_error("trigger fail: missing event name",
        "on test():\n"
        "    trigger()\n"
    );

    expect_parse_error("trigger fail: invalid event name (number)",
        "on test():\n"
        "    trigger 123()\n"
    );

    expect_parse_error("trigger fail: invalid event name (symbol)",
        "on test():\n"
        "    trigger @foo()\n"
    );

    expect_parse_error("trigger fail: missing parentheses",
        "on test():\n"
        "    trigger foo\n"
    );

    expect_parse_error("trigger fail: missing closing paren",
        "on test():\n"
        "    trigger foo(\n"
    );

    expect_parse_error("trigger fail: missing opening paren",
        "on test():\n"
        "    trigger foo)\n"
    );

    expect_parse_error("trigger fail: stray comma",
        "on test():\n"
        "    trigger foo(,)\n"
    );

    expect_parse_error("trigger fail: trailing comma",
        "on test():\n"
        "    trigger foo(a,)\n"
    );

    expect_parse_error("trigger fail: double comma",
        "on test():\n"
        "    trigger foo(a,,b)\n"
    );

    expect_parse_error("trigger fail: missing comma between args",
        "on test():\n"
        "    trigger foo(a b)\n"
    );

    expect_parse_error("trigger fail: invalid expression in args",
        "on test():\n"
        "    trigger foo(1 +)\n"
    );

    expect_parse_error("trigger fail: unterminated expression",
        "on test():\n"
        "    trigger foo((1+2)\n"
    );

    expect_parse_error("trigger fail: invalid range",
        "on test():\n"
        "    trigger foo(1..)\n"
    );

    expect_parse_error("trigger fail: invalid member access",
        "on test():\n"
        "    trigger foo(a.)\n"
    );

    expect_parse_error("trigger fail: invalid unary",
        "on test():\n"
        "    trigger foo(-)\n"
    );

    expect_parse_error("trigger fail: trigger used as event name",
        "on trigger():\n"
        "    say(\"hi\")\n"
    );

    expect_parse_error("trigger fail: trigger used as left-hand side of assignment",
        "on test():\n"
        "    trigger foo() = 1\n"
    );

    expect_parse_error("trigger fail: trigger used as callee",
        "on test():\n"
        "    trigger foo()(1)\n"
    );

    expect_parse_error("trigger fail: trigger used as member base",
        "on test():\n"
        "    trigger foo().bar()\n"
    );

    expect_parse_error("trigger fail: trigger at top level",
        "trigger foo()\n"
    );

    expect_parse_error("trigger fail: unexpected token after trigger",
        "on test():\n"
        "    trigger foo() ???\n"
    );

    expect_parse_error("trigger fail: missing newline after trigger",
        "on test():\n"
        "    trigger foo() say(\"hi\")\n"
    );

    std::cout << "Trigger (failure) tests completed." << std::endl;
}

void member_calls() {
    std::cout << "Running member calls (success) tests..." << std::endl;

    expect_ast("member calls: basic call",
        "on heal():\n"
        "\tif player.set_health(player.get_health + 5) > 10:\n"
        "\t\tsay(\"full health\")\n",
        "(Event heal:\n"
        "\t(If\n"
        "\t\t(Condition (Binary > (Call (Member (Ident player) set_health) "
        "(Binary + (Member (Ident player) get_health) (Literal 5))) (Literal 10)))\n"
        "\t\t(Then\n"
        "\t\t\t(Block\n"
        "\t\t\t\t(Command (Call (Ident say) (Literal \"full health\")))\n"
        "\t\t\t)\n"
        "\t\t)\n"
        "\t\t(Else (NoElse))\n"
        "\t)\n"
    ...
    std::cout << "Member calls (success) tests completed." << std::endl;
}
